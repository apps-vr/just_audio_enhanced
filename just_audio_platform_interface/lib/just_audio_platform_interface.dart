...
abstract class AudioPlayerPlatform {
  ...
  Future<SetOutputDeviceResponse> setOutputDevice(SetOutputDeviceRequest request) {
  ...
  /// on other platforms.
  Future<SetCanUseNetworkResourcesForLiveStreamingWhilePausedResponse> setCanUseNetworkResourcesForLiveStreamingWhilePaused(SetCanUseNetworkResourcesForLiveStreamingWhilePausedRequest request) {
...
class PlaybackEventMessage {
  ...
  static PlaybackEventMessage fromMap(Map<dynamic, dynamic> map) => PlaybackEventMessage(
        ...
        changeOutput: map['deviceID'] is String ? map['deviceID'] as String : null,
...
class LoadResponse {
  ...
  static LoadResponse fromMap(Map<dynamic, dynamic> map) => LoadResponse(duration: map['duration'] == null || map['duration'] as int < 0 ? null : Duration(microseconds: map['duration'] as int));
}
...
class SetOutputDeviceResponse {
  static SetOutputDeviceResponse fromMap(Map<dynamic, dynamic> map) => SetOutputDeviceResponse();
}
...
class SetOutputDeviceRequest {
  final String deviceID;

  SetOutputDeviceRequest({required this.deviceID});
...
class SetCanUseNetworkResourcesForLiveStreamingWhilePausedResponse {
  static SetCanUseNetworkResourcesForLiveStreamingWhilePausedResponse fromMap(Map<dynamic, dynamic> map) => SetCanUseNetworkResourcesForLiveStreamingWhilePausedResponse();
}
